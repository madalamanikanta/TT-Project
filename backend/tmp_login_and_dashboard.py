...
# login
url = "http://smart-internship-skill-matching-portal-2.onrender.com//api/auth/login"
...
url2 = "http://smart-internship-skill-matching-portal-2.onrender.com//api/admin/dashboard"
